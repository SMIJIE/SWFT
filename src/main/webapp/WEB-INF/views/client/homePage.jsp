...
<div id="content">
    <script type="text/javascript">
        ...
        function drawVisualization() {
            ...
            var options = {
                title: '<spring:message code="charts.caloriesPerMonth"/>: <spring:message code="month.${numMonth}"/>',
                seriesType: 'line',
                series: {2: {type: 'bars'}},
...
<script>
    function clickPage(currentPage) {
        window.location.href = '${pageContext.request.contextPath}/swft/user/homePage?' + currentPage.id;
    }
</script>
<%--Sent number of page--%>