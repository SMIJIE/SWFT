//package ua.training.controller.controllers.utility;
//
...
//    @Before
//    public void setUp() {
//        commandMap = ControllerUtil.commandMapInitialize();
...
//
//        returnPage = ControllerUtil.openUsersSession(request, user);
...
//        when(request.getServletContext()).thenReturn(context);
//        when(context.getAttribute(Attributes.REQUEST_USERS_ALL)).thenReturn(allUsers);
//        ControllerUtil.addUsersToContext(request, "Zakusylo@gmail.com", "Sasha@gmail.com");
...
//        when(request.getServletContext()).thenReturn(context);
//        when(context.getAttribute(Attributes.REQUEST_USERS_ALL)).thenReturn(allUsers);
//        ControllerUtil.deleteUsersFromContext(request, "Zakusylo@gmail.com", "Sasha@gmail.com");
//        assertTrue(allUsers.isEmpty());
//
//    }
//
...
//        String[] arr = {"11", "22"};
//        Integer[] parseArr = ControllerUtil.stringArrayToInteger(arr);
//        assertEquals(2, parseArr.length);
//
//        arr = new String[]{"Zakusylo@gmail.com", "Sasha@gmail.com"};
//        ControllerUtil.stringArrayToInteger(arr);
//    }
//
//    @Test
...
//
//        ControllerUtil.sortListByAnnotationFields(generalDish);
//
...
//
//        Dish to = new Dish();
//        ControllerUtil.updateDishParameters(from, to);
//
...
//        int count = ControllerUtil.getCountPages(3, 5);
//        assertEquals(1, count);
//
//        count = ControllerUtil.getCountPages(10, 5);
//        assertEquals(2, count);
//
//        count = ControllerUtil.getCountPages(12, 5);
//        assertEquals(3, count);
//    }
//
//    @Test
//    public void getMinMaxCurrentPage() {
//        int count = ControllerUtil.getMinMaxCurrentPage(0, 5);
//        assertEquals(1, count);
//
//        count = ControllerUtil.getMinMaxCurrentPage(3, 5);
//        assertEquals(3, count);
//
//        count = ControllerUtil.getMinMaxCurrentPage(12, 5);
